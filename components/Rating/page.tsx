...
export default function RatingRenderModal(productId: any) {
  ...
  const transId = productId.productId;
        ...
        {filteredTransacId.map((product: Histories) => (
          <>
            ...
            <div className="flex justify-center">
              <div className="w-[40%] absolute top-10 z-100 bg-white pb-10 shadow-xl rounded-2xl box-shadow-product mx-auto">
                <div className="pt-10">
                        ...
                        <div className="">
                          <p className="font-semibold text-[16px] text-[#58667E] leading-[1.8] break-words mb-2">
                            <span>
                              ...
                              bạn! Sự hài lòng của bạn là động lực lớn để chúng
                              tôi tiếp tục cung cấp dịch vụ và sản phẩm tốt
                              nhất. Nếu bạn có bất kỳ câu hỏi hoặc yêu cầu nào
                              khác, hãy liên hệ với chúng tôi.
                            </span>
                          </p>{" "}
                        </div>
                        <div className="">
