      ...
      <div>
       ...
       <div className="mt-[30px]">
          ...
          <div className="flex px-2 py-2.5 items-center rounded-[9px] border border-[#ececec] gap-2 font-semibold hover:border-[#c8c8c8bb] lg:px-5">
                <p className="text-[15px]  rounded-2xl bg-gray-200 animate-pulse text-gray-200   font-semibold ">
                  Tổng :
                </p>
                <p className="mb-4 rounded-2xl animate-pulse bg-gray-200 text-gray-200 line-clamp-1 w-[118px] justify-center font-semibold text-[14px] leading-20 md:m-0 lg:m-0">
                 10 kết quả
                </p>
              </div>
            <div className="flex relative mt-0 transition ease-in-out  mb-4 rounded-[9px] border border-[#ececec] px-3 py-1 md:mt-2 md:w-[100%] md:m-0 lg:mt-0 lg:m-0  lg:w-[100%] flex-1 hover:border-[#c8c8c8bb]">
