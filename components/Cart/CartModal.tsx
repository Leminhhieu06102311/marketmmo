       ...
       <div className=" w-full hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-0 mt-0 opacity-0 animate-showCart lg:max-w-md lg:w-full m-3">
          <div className="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-gray-800 dark:border-gray-700">
            ...
            <div className="p-4 overflow-y-auto min-h-[800px] flex flex-col items-center">
              <p className="text-gray-600 text-center mb-4 mt-10">Thêm sản phẩm để bắt đầu mua hàng</p>
              <button disabled type="button" className="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-blue-400 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all cursor-not-allowed text-sm">
              Hoàn tất mua hàng
              </button>
            </div>
