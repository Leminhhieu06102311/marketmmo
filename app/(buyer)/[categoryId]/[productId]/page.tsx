  ...
  return (
    <div className=" w-full h-full fixed top-0 right-0 left-0 ">
      ...
      <div className="bg-white rounded-l-lg w-full top-14   absolute bottom-0 left-0 right-0  pb-52 overflow-y-scroll">
          ...
          <div className="flex gap-3">
            <div className="border cursor-pointer border-gray-300 rounded-full w-10 h-10 flex items-center justify-center hs-tooltip [--trigger:hover] [--placement:left] ">
              <div className="hs-tooltip-toggle block" >
                <div
                  className="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible opacity-0 transition-opacity inline-block absolute invisible z-10 py-3 px-4 bg-slate-900 text-white text-xs rounded-xl"
                  role="tooltip"
                >
                  Thích
                </div>
        ...
        <div className="w-full  bg-[#F9F3EF] rounded-3xl mt-10 mb-5 mx-auto md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl 2xl:max-w-screen-2xl p-10 gap-5 flex">
          <div className="w-1/2 flex gap-5 flex-col">
            ...
            <div className="bg-white rounded-2xl w-full p-4 flex gap-3">
              <div>
          ...
          <div className="w-1/2 flex gap-5 flex-col">
            <div className="bg-white  rounded-2xl w-full p-4">
              <div className="flex gap-2">
                ...
                <h2 className="text-2xl text-primary font-bold flex-1">
                  Gmail NEW iOS Us và Ngoại. Chỉ bán min 30 cái Chỉ bán min 30
                  cái
                </h2>
              </div>
              <div className="pt-2 py-5 inline-flex items-center border border-b-gray-300 border-l-0 border-r-0 border-t-0 ">
                <div className=" flex gap-2">
              ...
              <div className="flex gap-2 flex-col my-2">
                ...
                <div className="inline-flex flex-col gap-2">
                  ...
                  <button
                    data-type="3"
                    className="bg-white p-2 rounded-lg text-black text-sm inline border border-gray-300 cursor-pointer"
                  >
                    Gmail random IP 7 ngày++ email|pass|recovery|geo
                  </button>
                  <button
            ...
            <div className="bg-white  rounded-2xl w-full p-4">
              ...
              <div className=" py-3 flex gap-2">
                <div className="border border-gray-200 rounded-md inline-flex py-3 px-3 items-center">
                  ...
                  <input
                    type="text"
                    className=" inline px-3 w-20 text-center text-base outline-none  focus:border-blue-500 focus:ring-blue-500 "
                    value={selectQuantity}
                  />
                  <button onClick={() => setSelectQuantity(selectQuantity + 1)}>
                    <svg
                      className="w-4 h-4"
                      viewBox="0 0 24 24"
                      fill="none"
        ...
        <div className="mx-auto md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl 2xl:max-w-screen-2xl ">
          ...
          <div className="w-full h-96 rounded-3xl border border-gray-200 p-10">
