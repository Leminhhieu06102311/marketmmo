...
const BuyerHistory = () => {
      ...
      try {
        const response = await axios.get('/order/histories', {
          params: {
            limit: 30,
            page: 1,
            before: '' // Thay đổi giá trị 'before' theo nhu cầu của bạn
          }
        });
  ...
  return (
    <>
        {accessToken ? (
      <p>      <div className="max-w-xxs mx-auto md:max-w-3xl lg:max-w-full  px-5">
      <div className="pt-10">
        <div className="lg:px-5">
          <div className="flex gap-x-6 justify-between md:justify-around lg:justify-start">
            ...
            <div className="text-center" onClick={() => handleTabClick(1)}>
              <button
                className={`${
                  activeTab === 1 ? "text-black bg-[#1212120a]" : "text-gray-700 bg-none"
            ...
            <div className="text-center" onClick={() => handleTabClick(2)}>
              <button
                className={`${
                  activeTab === 2 ? "text-black bg-[#1212120a]" : "text-gray-700 bg-none"
                } leading-16 font-semibold  px-4 py-3 rounded-[10px]`}
            ...
            <div className="text-center">
              <button
                className={`${
                  activeTab === 3 ? "text-black bg-[#1212120a]" : "text-gray-700 bg-none"
                } leading-16 font-semibold  px-4 py-3 rounded-[10px]`}
