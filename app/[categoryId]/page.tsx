        ...
        <>
            <div className="mx-auto ">
                <div className="flex w-full">
                    {/* Aside */}
                    <div className="lg:block lg:w-71 md:w-24 md:block hidden  border-r ">
                        {/* Vertical navigation  */}
                        <div className=" px-6 pt-6 block scroll-auto overflow-y-auto max-h-screen sticky top-0 overscroll-contain">
                            <ul className="lg:block md:justify-center sticky flex flex-wrap ">
                                <li className="bg-gray-100 lg:my-1 lg:w-full md:m-0 md:w-7 rounded-md hover:bg-gray-100 p-1">
                                    <Link
                                        href="/intermediary"
                                        className="lg:justify-start md:justify-center flex items-center  "
                                    >
                                        <span className="lg:mr-4"><FontAwesomeIcon icon={faFireFlameCurved} width={20} height={20} /></span>
                                        <span className="lg:block md:hidden text-sm font-medium leading-10">Xu hướng</span>
                                    </Link>
                                </li>
                                <li className="lg:my-1 lg:w-full md:my-3 md:w-7 rounded-md hover:bg-gray-100 p-1">
                                    <Link
                                        href="/intermediary"
                                        className="lg:justify-start md:justify-center flex items-center "
                                    >
                                        <span className="lg:mr-4"><FontAwesomeIcon icon={faArrowDownShortWide} width={20} height={20} /></span>
                                        <span className="lg:block md:hidden text-sm font-medium leading-10">Giảm giá</span>
                                    </Link>
                                </li>
                            </ul>
                            <span className="lg:block hidden sticky text-sm  font-medium text-gray-400">Networks</span>
                            <ul className="sticky">
                                <li className="lg:my-1 md:my-3 rounded-md lg:hover:bg-gray-100 cursor-pointer">
                                    <Link href="" className="lg:justify-start md:justify-center flex items-center ">
                                        ...
                                        <span className="lg:block md:hidden py-1 leading-10 text-sm font-medium">Messenger</span>
                                    </Link>
                                </li>
                                <li className="lg:my-1 md:my-3 rounded-md lg:hover:bg-gray-100 cursor-pointer">
                                    <Link href="" className="lg:justify-start md:justify-center flex items-center ">
                                        ...
                                        <span className="lg:block md:hidden py-1 leading-10 text-sm font-medium">Twitter</span>
                                    </Link>
                                </li>
                                <li className="lg:my-1 md:my-3 rounded-md lg:hover:bg-gray-100 cursor-pointer">
                                    <Link href="" className="lg:justify-start md:justify-center flex items-center ">
                                        ...
                                        <span className="lg:block md:hidden py-1 leading-10 text-sm font-medium">Tiktok</span>
                                    </Link>
                                </li>
                                <li className="lg:my-1 md:my-3 rounded-md lg:hover:bg-gray-100 cursor-pointer">
                                    <Link href="" className="lg:justify-start md:justify-center flex items-center ">
                                        ...
                                        <span className="lg:block md:hidden py-1 leading-10 text-sm font-medium">Gmail</span>
                                    </Link>
                                </li>
                                <li className="lg:my-1 md:my-3 rounded-md lg:hover:bg-gray-100 cursor-pointer">
                                    <Link href="" className="lg:justify-start md:justify-center flex items-center ">
                                        ...
                                        <span className="lg:block md:hidden py-1 leading-10 text-sm font-medium">Yahoo!</span>
                                    </Link>
                                </li>
                                <li className="lg:my-1 md:my-3 rounded-md lg:hover:bg-gray-100 cursor-pointer">
                                    <Link href="" className="lg:justify-start md:justify-center flex items-center ">
                                        ...
                                        <span className="lg:block md:hidden py-1 leading-10 text-sm font-medium">Facebook</span>
                                    </Link>
                                </li>
                                <li className="lg:my-1 md:my-3 rounded-md lg:hover:bg-gray-100 cursor-pointer">
                                    <Link href="" className="lg:justify-start md:justify-center flex items-center ">
                    ...
                    {/* Product List */}
                    <div className="lg:w-full lg:max-w-7xl lg:px-12 md:w-11/12 md:max-w-3xl px-1 max-w-xxs mx-auto ">
                        {/* Category */}
                        <div className="my-3 top-0">
                            <div className="lg:flex lg:justify-end lg:max-w-7xl lg:mx-auto md:flex md:justify-center  md:max-w-3xl md:mx-auto text-xs font-semibold  justify-center ">
                                <div className="lg:justify-start md:justify-center my-2 flex items-center justify-between">
                                    ...
                                    <ul className="lg:mr-2 md:mr-2  inline-flex items-center bg-gray-100  rounded-lg">
                                        <li className=""><button className="bg-white px-4 py-2 m-1 rounded-md active:bg-white hover:bg-white" >Tất cả</button></li>
                                ...
                                <div className="lg:mr-2 md:mr-2 my-2 hover:bg-white text-gray-600">
                                    <button className="lg:w-32 md:w-32 w-full">
                                        <div className="w-full bg-gray-100  p-3 rounded-lg outline-none text-black flex justify-between items-center">
                                            <span className="mr-2">Category</span>
                                            <span>
                                                <FontAwesomeIcon icon={faAngleDown} width={12} height={12} />
                                            </span>
                                        </div>
                                        <div className="lg:block lg:w-32 md:block md:w-32 w-category-mobile absolute  rounded-xl mt-2 bg-white dropdown-boxshadown before:content-[''] before:w-0 before:h-0 before:border-solid before:border-[10px] before:border-white before:top-[-19px] before:border-l-transparent before:border-r-transparent before:border-t-transparent before:absolute before:left-[55px]">
