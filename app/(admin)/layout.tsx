...
export default function AdminLayout({
    ...
    return (
        ...
        <div className="bg-[#f9fafb] p-6 max-w-[1536px] w-full m-auto ">
            ...
            <div className="flex relative ">
                ...
                <div className="w-full md:w-full lg:w-[100% calc(100%-280px)] relative">
                    {searchModallOpen && (
                        <div className=" inset-0  items-center justify-center z-50 ">
                            <div className="fixed inset-0 bg-transparent" onClick={closeSearch}></div>
                            <div className="fixed w-[1251px] shadow-lg right-0 bg-[#f9fafbcc] bg-blur-[6px] h-[80px]  animate__animated animate__slideInDown animate__faster flex items-center lg:px-10 ">
