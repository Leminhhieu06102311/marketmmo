    ...
    return (
        <div className="p-6 max-w-[1536px] w-full m-auto">
            <div className='flex justify-between items-center mb-3'>
                ...
                <button className='px-4 py-[6px] text-sm text-white font-semibold bg-primary flex justify-center items-center rounded-lg'><IoMdAdd className="text-xl font-bold mr-1" /><span>New User</span></button>
            </div>
            <div>
