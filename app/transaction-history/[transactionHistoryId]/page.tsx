                ...
                <div>
                              ...
                              <div>
                                <div className="">
                                  <p className="font-semibold text-[16px] text-[#58667E] leading-[1.8] break-words mb-2">
                                    <span>
                                      Cảm ơn rất nhiều vì sự tin tưởng và sự ủng
                                      hộ của bạn! Sự hài lòng của bạn là động
                                      lực lớn để chúng tôi tiếp tục cung cấp
                                      dịch vụ và sản phẩm tốt nhất. Nếu bạn có
                                      bất kỳ câu hỏi hoặc yêu cầu nào khác, hãy
                  ...
                  >
                    ...
                    />
                              ...
                              {rating === 0 && (
                                <p>
                                  <button onClick={() => handleRatingClick(1)}>
                                    <svg
                                      width="27"
                                      height="27"
                                      viewBox="0 0 22 22"
