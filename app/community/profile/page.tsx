...
export default function profile_user() {
    ...
    return (
        <div className=" mx-auto max-w-xxs  md:max-w-3xl lg:max-w-8xl flex relative min-h-[calc-108px] m-auto pointer-events-auto">
            <div className="flex relative max-w-[1400px] min-h-[calc(100vh-108px)] m-auto">
                ...
                <main className="bg-white grow-[3] shrink basis relative z-10">
                    <div className="flex flex-row justify-between">
                                            ...
                                            <div className="border-box m-0 flex">
                                                    ...
                                                    <div className="cursor-pointer relative">
                                                        <a href="" className="md:w-32 md:h-32 w-[74px] h-[74px] p-2 rounded-full shadow-md bg-white overflow-hidden flex items-center justify-center">
                                                            <div className="w-[110px] h-[110px] rounded-full bg-[#f8fafd] transition-border duration-200 ease-out overflow-hidden">
                                                                <img className="w-full h-full object-cover" src="../images/community/user.png" alt="Image" />
                                                            </div>
                                                        </a>
                                                    </div>
                                                ...
                                                <div className="flex flex-row box-border m-0 justify-between grow-[2]">
                                                    <div className="ml-6 mt-10 border-box">
                                                        <p className="truncate text-[18px] leading-6 m-0 text-gray-700 font-semibold">ddq7mexeifil</p>
                                                        <p className="truncate md:text-[14px] text-[12px] leading-6 m-0 text-gray-500"></p>
                        ...
                        <div className="max-w-[350px] min-w-[300px] grow basis-0 shrink-0 m-0 mx-4 ml-0.5 hidden lg:block">
