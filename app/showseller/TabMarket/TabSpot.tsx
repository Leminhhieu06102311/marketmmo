...
export default function TabSpot() {
        ...
        <div className="overflow-x-auto">
          <div>
            ...
            <table className="min-w-full lg:m-auto text-base w-full isolation-isolate">
              <thead className="sticky top-0 z-11 bg-white">
                <tr>
                  ...
                  <th className="sticky left-[38px] bg-white z-10 lg:border-t border-b border-solid border-table-divider-color py-2 px-2 z-11 text-sm">
                    ...
                    <div>
                      <div>
                        <p className="whitespace-nowrap text-left text-[12px] ">
                          Đơn vị tiền tệ
                        </p>
                        <span></span>
                      </div>
                  ...
                  <th className="lg:border-t border-b border-solid border-table-divider-color py-2 px-2 z-11 text-sm">
                    {" "}
                    <div>
                      <div>
                  ...
                  <th className="lg:border-t border-b border-solid border-table-divider-color py-2 px-2 z-11 text-sm">
                    ...
                    <div>
                      <div>
                        <span></span>
                        <p className="md:text-[12px] text-right text-[12px]">
                          Giá
                        </p>
                      </div>
                    </div>
                  ...
                  <th className="lg:border-t border-b border-solid border-table-divider-color py-2 px-2 z-11 text-sm">
                    ...
                    <div>
                      <div>
                        <span></span>
                        <p className="whitespace-nowrap md:text-[12px] text-right text-[12px]">
                          +2% Độ sâu thị trường
                        </p>
                      </div>
                    </div>
                  </th>
                  <th className="border-b border-solid py-2 px-2 text-sm md:border-t border-table-divider-color  z-11 lg:border-t  border-table-divider-color z-11">
                    {" "}
                    <div>
                      <div>
                        <span></span>
                        <p className="whitespace-nowrap text-right text-[12px]">
                          -2% Độ sâu thị trường
                        </p>
                      </div>
                    </div>
                  ...
                  <th className="border-b border-solid py-2 px-2 text-sm md:border-t  border-table-divider-color  z-11  lg:border-t border-table-divider-color z-11">
                    ...
                    <div>
                      <div>
                        <span></span>
                        <p className="whitespace-nowrap text-[12px] text-right">
                  ...
                  <th className="lg:border-t border-b border-solid border-table-divider-color py-2 px-2 z-11 text-sm">
                    ...
                    <div>
                      <div>
                        <div>
                          <span></span>
                          <p className="whitespace-nowrap md:text-[12px] text-right">
                            Khối lượng giao dịch %
                          </p>
                        </div>
                      </div>
                  ...
                  <th className="whitespace-nowrap border-b border-solid py-2 px-2 text-[12px] text-right md:border-t border-table-divider-color  z-11  lg:border-t border-table-divider-color z-11">
                    Cập nhật
                  </th>
                </tr>
              </thead>
              <tbody>
                <tr className="hover:bg-slate-50">
                  <td className="sticky text-center left-0 bg-white z-20 whitespace-nowrap lg:font-medium p-[4px] border-b border-table-divider-color">
                    <p
                  ...
                  <td className="sticky left-[38px] bg-white z-10 whitespace-nowrap text-left font-medium p-4 border-b border-table-divider-color">
                    <Link href="">
                      <div
                        data-sensors-click="true"
                  ...
                  <td className="whitespace-nowrap lg:text-left font-medium p-4 border-b border-table-divider-color">
                    <div className="flex md:flex lg:flex items-center leading-none text-[14px]">
                      <Link
                  ...
                  <td className="whitespace-nowrap lg:text-right font-medium p-4 border-b border-table-divider-color">
                    <p
                  ...
                  <td className="whitespace-nowrap lg:text-right font-medium p-4 border-b border-table-divider-color leading-6 m-0 text-[14px]">
                    $10,952,560.94
                  </td>
                  <td className="whitespace-nowrap lg:text-right font-medium p-4 border-b border-table-divider-color leading-6 m-0 text-[14px]">
                    $7,086,602.42
