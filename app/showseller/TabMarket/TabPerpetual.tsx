...
export default function TabPerpetual() {
            ...
            <table className="min-w-full lg:m-auto text-base w-full isolation-isolate">
              <thead className="lg:sticky top-0 z-11 bg-white">
                <tr className="whitespace-nowrap">
                  ...
                  <th className="md:text-[12px] lg:border-t border-b border-solid border-table-divider-color py-2 px-2 z-11 text-sm">
                    {" "}
                    <div>
                      <div>
                        <span></span>
                  ...
                  <th className="md:text-[12px] lg:border-t border-b border-solid border-table-divider-color py-2 px-2 z-11 text-[12px] text-right">
                    Cập nhật
                  </th>
                </tr>
              </thead>
